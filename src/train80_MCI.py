...
def main():
    ...
    images_train, images_test, labels_train, labels_test, names_train, names_test= train_test_split(images,labels,names,test_size=0.35, random_state=42)
    ...
    for n_batch in batch:
        ...
        for lr in learning_rate:
            ...
            np.save("compressed_5500nodes_"+str(n_batch)+"_lr"+str(lr), compressed5500)
            np.save("compressed_128nodes_" + str(n_batch) + "_lr" + str(lr), compressed128)
